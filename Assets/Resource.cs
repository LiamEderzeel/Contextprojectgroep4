...
public class Resource : MonoBehaviour {
	...
	void OnGUI ()
	{
		...
		{
			GUI.Label (new Rect (boxPosition.x-40,boxPosition.y-25,80,50),"Graan",ResourceName);
		}
		if(this.gameObject.name == "Resource_2")
		{
			GUI.Label (new Rect (boxPosition.x-40,boxPosition.y-25,80,50),"Vlees",ResourceName);
		}
		if(this.gameObject.name == "Resource_3")
		{
			GUI.Label (new Rect (boxPosition.x-40,boxPosition.y-25,80,50),"Water",ResourceName);
		}
	}
}
